...
# build directory.
TCL_BUILD_LIB_SPEC='-L/windows/etudes/ECE/ING4/PPE/python/Q_learning/reinforcement_FollE/tcl8.6.6/unix -ltcl8.6'
...
# compiled.
TCL_SRC_DIR='/windows/etudes/ECE/ING4/PPE/python/Q_learning/reinforcement_FollE/tcl8.6.6'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/windows/etudes/ECE/ING4/PPE/python/Q_learning/reinforcement_FollE/tcl8.6.6/unix -ltclstub8.6'
...
TCL_BUILD_STUB_LIB_PATH='/windows/etudes/ECE/ING4/PPE/python/Q_learning/reinforcement_FollE/tcl8.6.6/unix/libtclstub8.6.a'
